...
<html lang="en">
  ...
  <body>
    <header>
      <div class="head">
      <a href="{{route('index')}}"><img src="{{URL('images/o1/buildalogowing.jpg')}}" width="43px" height="48px" /></a>
        <div class="build">
      <a href="{{route('index')}}"><img src="{{URL('images/o1/BUILDAwing.jpg')}} " width="105px" height="25px" /></a>
        </div>
      </div>
    </header>
  ...
  <button class="sk" type="submit" name="skip"><a href="{{route('templates')}}">Skip</a></button>
</div>
    </div>
  </body>
</html>
