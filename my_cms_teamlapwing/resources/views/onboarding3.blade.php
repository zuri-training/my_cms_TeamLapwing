...
<html lang="en">
  ...
  <body>
    <header>
      <div class="head">
      <a href="{{route('index')}}"><img src="{{URL('images/o3/buildalogowing.jpg')}}" width="43px" height="48px" /></a>
        <div class="build">
        <a href="{{route('index')}}"><img src="{{ URL('images/o3/BUILDAwing.jpg') }} " width="105px" height="25px" /></a>
        </div>
      </div>
    </header>
